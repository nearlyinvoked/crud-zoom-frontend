...
import { ChevronLeft, ChevronRight, Video, Users, ExternalLink } from "lucide-react"
...
export default function ZoomCalendar() {
  ...
  const calculateEndTime = (startTimeString: string, durationMinutes: number): string => {
          ...
          {calendarDays.map((day, index) => {
            ...
            return (
              ...
              >
                {day && (
                  <>
                    <div className={`text-sm font-medium p-1 ${isToday ? "text-primary" : ""}`}>{day}</div>
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <div
                                  ...
                                  onClick={() => openMeetingLink(meeting.join_url)}
                                >
                                  ...
                                  <div className="flex items-center gap-1 text-muted-foreground">
                                    ...
                                    <span>
                                      ...
                                      {calculateEndTime(meeting.start_time, meeting.duration)}
                                    </span>
                                  </div>
                                </div>
                              </TooltipTrigger>
